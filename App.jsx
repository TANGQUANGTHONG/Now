...
import { saveCurrentUserAsyncStorage, saveChatsAsyncStorage, getChatsByUserId, saveUserUidToAsyncStorage, getAllUsersFromUserSend } from './src/storage/Storage';
...
const App = () => {
  ...
  //   const currentUserUid = 'QjK4YznKo7goHyDxTxQ3RY13OEC2';  // UID của người dùng hiện tại
