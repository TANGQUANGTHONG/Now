...
import { saveCurrentUserAsyncStorage, saveChatsAsyncStorage, getChatsByUserId } from './src/storage/Storage';
...
const App = () => {
  ...
  const getUserChats = async () => {
    const currentUserUid = 'e6oC9052huSmPQLtn7VUMDeWx5X2';  // UID của người dùng hiện tại
