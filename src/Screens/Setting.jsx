...
import { View, Text, Image, StyleSheet, TouchableOpacity, Dimensions, Pressable, ScrollView } from "react-native";
...
const styles = StyleSheet.create({
  ...
  textSetting: { fontSize: width * 0.05, fontWeight: '500', color: '#fff' },
  option: { flexDirection: "row", alignItems: "center", padding: width * 0.03, backgroundColor: "white", marginVertical: height * 0.01, borderRadius: width * 0.03 },
  optionIcon: { width: width * 0.1, height: width * 0.1, borderRadius: width * 0.05, backgroundColor: "#f0f0f0", justifyContent: "center", alignItems: "center" },
  optionText: { marginLeft: width * 0.04 },
  optionTitle: { color: "black", fontSize: width * 0.045, fontWeight: "bold" },
  optionTitle1: { color: "red", fontSize: width * 0.045, fontWeight: "bold" },
  profile: { flexDirection: "row", alignItems: "center", backgroundColor: "white", borderBottomLeftRadius: width * 0.05, borderBottomRightRadius: width * 0.05, padding: width * 0.03, marginVertical: height * 0.02 },
  avatar: { width: width * 0.15, height: width * 0.15, borderRadius: width * 0.075 },
  profileInfo: { flex: 1, marginLeft: width * 0.04 },
  name: { color: "black", fontSize: width * 0.045, fontWeight: "bold" },
  status: { color: "gray", fontSize: width * 0.035 },
});
